...
avg_samples_between_updates = 12000
update_rounds = 12000 # 3600
max_batch_size=800
multi_batch_size = 5
...
- Gateway, AWS, US / N. Virginia (us-east-1), t3.micro,2 vCPUs, 1024MiB Mem, 8GB Stroage, 0.064 Gigabit
- Worker 3 + Data: AWS, US / N. Virginia (us-east-1), c5a.8xlarge, 32 vCPUs, 65536MB Mem, 350GB Stroage, 10.0 Gigabit
- Worker 1: AWS, US / N. Virginia (us-east-1), g6e.xlarge, L40S 46068MiB (nvidia-smi) 45776MiB (aws describe-instance) GPU, 4 vCPUs, 32768MiB Mem, 300GB Storage, 2.5 Gigabit
...
- Worker6: CANADA-1, L40 46068MiB (nvidia-smi) GPU, 28 CPUs, 58 GB Mem, 100 GB (root) + 725 GB (ephemeral) Storage
